/* ng-infinite-scroll - modified to include parent, parent-id - */
/* https://github.com/danman01/ngInfiniteScroll */
  ...
  '$rootScope', '$window', '$timeout', function($rootScope, $window, $timeout) {
    return {
      link: function(scope, elem, attrs) {
        ...
        if (attrs.infiniteScrollParentId != null) {
          container = elem.parents("#"+attrs.infiniteScrollParentId);
          scope.$watch(attrs.infiniteScrollParentColumn, function() {
            return container = elem.parents("#"+attrs.infiniteScrollParentId);
          });
        }
        handler = function() {
